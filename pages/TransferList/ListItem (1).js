...
export default function ListItemComponent({url,data}) {
  ...
  return (
    <>
    {data?.component?.options?.mode==='ENHANCE'? (<Grid container spacing={2} justifyContent="center" alignItems="center">
